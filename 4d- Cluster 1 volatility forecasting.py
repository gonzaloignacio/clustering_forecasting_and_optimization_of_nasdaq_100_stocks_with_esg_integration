...
rfr_selected = RandomForestRegressor(n_estimators = rfr_best_estimators,
                                     max_depth = rfr_best_depth,
                                     max_features = rfr_best_features,
                                     min_samples_leaf = rfr_best_samples,
                                     random_state = seed)
rfr_selected.fit(X_full, y_full)
...
for ticker in ticker_c0:
    ...
    y_pred_scaled = rfr_selected.predict(pd.DataFrame([X_ticker]))
